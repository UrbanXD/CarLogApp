    ...
    const submitHandler = handleSubmit(
        async (formResult: OdometerLogFields) => {
            try {
                ...
                await odometerDao.createOdometerLog(odometerLogRow, car?.odometer.unit ?? OdometerUnit.KILOMETER);
        ...
        <>
            <Form containerStyle={ { paddingBottom: SEPARATOR_SIZES.small } }>
                ...
                <Input.Field
                    ...
                    fieldInfoText={ car && `A jelenlegi kilométeróra állás: ${ car.odometer.value } ${ car.odometer.unit }` }
                >
                    <Input.Row style={ { gap: 0 } }>
                        ...
                        <OdometerUnitText text={ car?.odometer.unit }
                                          style={ { padding: SEPARATOR_SIZES.lightSmall } }></OdometerUnitText>
                    </Input.Row>
                </Input.Field>
                <Input.Field
                    control={ control }
